...
def _open_not_evaluable(detail: str) -> dict:
    ...
    Courthouse `docs/FAIL-DIRECTION.md` §3 (this repo has no `docs/` prose; the
    link is in README "Prior art") records 30 such allows in one day going unnoticed, and says of
