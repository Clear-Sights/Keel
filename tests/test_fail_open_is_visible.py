...
Courthouse `docs/FAIL-DIRECTION.md` §3 -- not in this tree; README links it
under "What Keel writes down" -- states the rule and, unusually, states that it was not true:
