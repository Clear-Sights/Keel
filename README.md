...
| `U08` | create a signed git commit | observe a PGP or SSH signature block, `Good signature` verification output, or `gpgsig` commit data | [POINTS.md#u08](plugin/POINTS.md#u08) |
